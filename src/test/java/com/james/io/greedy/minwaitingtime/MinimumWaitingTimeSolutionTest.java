...
public class MinimumWaitingTimeSolutionTest {
    ...
    public void testGetMinimumWaitingTimeEmptyList() {
        Assert.assertEquals(0, MinimumWaitingTimeSolution.getMinimumWaitingTime(Collections.emptyList()));
    }

    @Test
    public void testGetMinimumWaitingTimeOneElement() {
        Assert.assertEquals(0, MinimumWaitingTimeSolution.getMinimumWaitingTime(Collections.singletonList(10000)));
    }
}
