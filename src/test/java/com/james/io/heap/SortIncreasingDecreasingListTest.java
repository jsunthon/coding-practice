...
public class SortIncreasingDecreasingListTest {
  ...
  public void sortIncDecEmpty() {
    assertEquals(Collections.emptyList(),
        SortIncreasingDecreasingList.sortIncDec(Collections.emptyList()));
  }

  @Test
  public void sortIncDecSingleton() {
    assertEquals(Collections.singletonList(1),
        SortIncreasingDecreasingList.sortIncDec(Collections.singletonList(1)));
  }

  @Test
  public void sortIncDecStrictlyIncr() {
    assertEquals(Arrays.asList(1, 2, 3),
        SortIncreasingDecreasingList.sortIncDec(Arrays.asList(1, 2, 3)));
  }

  @Test
  public void sortIncDecStrictlyDecr() {
    assertEquals(Arrays.asList(1, 2, 3),
        SortIncreasingDecreasingList.sortIncDec(Arrays.asList(3, 2, 1)));
  }
}