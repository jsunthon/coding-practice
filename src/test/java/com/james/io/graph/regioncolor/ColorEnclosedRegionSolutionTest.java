...
public class ColorEnclosedRegionSolutionTest {
  ...
  public void testColorOkRegionInner() {
    ...
    ColorEnclosedRegionSolution colorEnclosedRegionSolution = new ColorEnclosedRegionSolution(
        graph);
    colorEnclosedRegionSolution.color();

    assertEquals(Stream.of(Mark.B, Mark.B, Mark.B, Mark.B).collect(Collectors.toList()),
        graph.get(0));
    assertEquals(Stream.of(Mark.W, Mark.B, Mark.B, Mark.B).collect(Collectors.toList()),
        graph.get(1));
    assertEquals(Stream.of(Mark.B, Mark.B, Mark.B, Mark.B).collect(Collectors.toList()),
        graph.get(2));
    assertEquals(Stream.of(Mark.B, Mark.B, Mark.B, Mark.B).collect(Collectors.toList()),
  ...
  public void testColorAllBoundaryNoEnclosedRegion() {
    ...
    assertEquals(Stream.of(Mark.W, Mark.W, Mark.W, Mark.W).collect(Collectors.toList()),
        graph.get(0));
    assertEquals(Stream.of(Mark.W, Mark.B, Mark.B, Mark.W).collect(Collectors.toList()),
        graph.get(1));
    assertEquals(Stream.of(Mark.W, Mark.B, Mark.B, Mark.W).collect(Collectors.toList()),
        graph.get(2));
    assertEquals(Stream.of(Mark.W, Mark.W, Mark.W, Mark.W).collect(Collectors.toList()),
