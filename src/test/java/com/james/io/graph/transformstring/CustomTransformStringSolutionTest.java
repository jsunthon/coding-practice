...
public class CustomTransformStringSolutionTest {
    ...
    public void testGetProductionSequence_ok() {
        ...
        Assert.assertEquals(4, new CustomTransformStringSolution().getProductionSequence(dict, s, t));
    }
    ...
    public void testGetProductSequence_moreThanOnePath() {
        ...
        Assert.assertEquals(4, new CustomTransformStringSolution().getProductionSequence(dict, "cat", "dog"));
    }
}
